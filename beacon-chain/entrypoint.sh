...
"ephemery-geth.dnp.dappnode.eth")
    HTTP_ENGINE="http://ephemery-geth.dappnode:8551"
    ;;
"goerli-nethermind.dnp.dappnode.eth")
    HTTP_ENGINE="http://ephemery-nethermind.dappnode:8551"
    ;;
"goerli-besu.dnp.dappnode.eth")
    HTTP_ENGINE="http://ephemery-besu.dappnode:8551"
    ;;
"goerli-erigon.dnp.dappnode.eth")
    HTTP_ENGINE="http://ephemery-erigon.dappnode:8551"
    ;;
*)
